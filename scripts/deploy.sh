...
Environment variables:
  ...
  CF_RATE_LIMIT_GLOBAL_MODE               Override RATE_LIMIT_GLOBAL_MODE (off|shadow|enforce)
  CF_RATE_LIMIT_GLOBAL_DO_SHARDS          Override RATE_LIMIT_GLOBAL_DO_SHARDS (default: 32)
  CF_RATE_LIMIT_GLOBAL_TIMEOUT_MS         Override RATE_LIMIT_GLOBAL_TIMEOUT_MS (default: 50)
  CF_RATE_LIMIT_GLOBAL_FAIL_OPEN          Override RATE_LIMIT_GLOBAL_FAIL_OPEN (default: true)
...
append_optional_var "RATE_LIMIT_GLOBAL_MODE" "${CF_RATE_LIMIT_GLOBAL_MODE:-}"
append_optional_var "RATE_LIMIT_GLOBAL_DO_SHARDS" "${CF_RATE_LIMIT_GLOBAL_DO_SHARDS:-}"
append_optional_var "RATE_LIMIT_GLOBAL_TIMEOUT_MS" "${CF_RATE_LIMIT_GLOBAL_TIMEOUT_MS:-}"
append_optional_var "RATE_LIMIT_GLOBAL_FAIL_OPEN" "${CF_RATE_LIMIT_GLOBAL_FAIL_OPEN:-}"
